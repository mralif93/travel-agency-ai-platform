<x-app-layout>
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Edit Company</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Update company details.</p>
        </div>
    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="address" name="address" rows="3"
                                class="block w-full rounded-lg border-0 py-2.5 px-3 text-gray-900 dark:text-white dark:bg-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 placeholder:text-gray-400 sm:text-sm sm:leading-6">{{ old('address', $company->address) }}</textarea>
                        </div>
                        @error('address')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
