<x-app-layout>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Companies</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">A list of all the partnering companies.</p>
        </div>
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <a href="{{ route('companies.create') }}"
                class="block rounded-md bg-primary-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">
                <i class='bx bx-plus align-middle mr-1'></i>Create Company
            </a>
        </div>
    </div>
                    ...
                    <div class="w-full sm:flex-1">
                        ...
                        <div class="relative rounded-md">
                            ...
                            <input type="text" name="search" id="search" value="{{ request('search') }}"
                                ...
                                placeholder="Name, Email, Phone or Reg. No">
                        </div>
                    </div>
        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden">
                            ...
                            @foreach ($companies as $company)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                    <td
                                        ...
                                        <div class="text-xs text-gray-500">{{ $company->registration_number }}</div>
                                    </td>
                    ...
                    <x-card-pagination :items="$companies" />
                </div>
            </div>
        </div>
    </div>
