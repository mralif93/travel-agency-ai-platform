<x-app-layout>
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Create Company</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Add a new partner company to the system.</p>
        </div>
    </div>
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        <label for="name"
                            class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">Company
                            Name</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-3">
                        <label for="registration_number"
                            class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">Registration
                            No.</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="text" name="phone" id="phone" autocomplete="tel" value="{{ old('phone') }}"
                                class="block w-full rounded-lg border-0 py-2.5 px-3 text-gray-900 dark:text-white dark:bg-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                        </div>
                        @error('phone')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="address" name="address" rows="3"
                                class="block w-full rounded-lg border-0 py-2.5 px-3 text-gray-900 dark:text-white dark:bg-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 placeholder:text-gray-400 sm:text-sm sm:leading-6">{{ old('address') }}</textarea>
                        </div>
                        @error('address')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
