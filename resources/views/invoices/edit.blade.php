<x-app-layout>
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Edit Invoice</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Update invoice details.</p>
        </div>
    </div>
                        ...
                        <div class="mt-2 relative">
                            <select id="status" name="status"
                                ...
                                <option value="pending"
                                    {{ old('status', $invoice->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                                <option value="paid"
                                    {{ old('status', $invoice->status) == 'paid' ? 'selected' : '' }}>Paid</option>
                                <option value="overdue"
                                    {{ old('status', $invoice->status) == 'overdue' ? 'selected' : '' }}>Overdue
                                </option>
                            </select>
                            <div
