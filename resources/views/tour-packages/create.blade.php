<x-app-layout>
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">Create Tour Package</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Add a new tour package for customers to explore.</p>
        </div>
    </div>

    <div class="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden">
        <form action="{{ route('admin.tour-packages.store') }}" method="POST" enctype="multipart/form-data" x-data="tourPackageForm()">
            @csrf
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <textarea name="description" id="description" rows="5"
                                class="block w-full rounded-md border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 dark:bg-gray-900 dark:text-white dark:ring-gray-700"
                                placeholder="Detailed description of the tour package...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input type="number" name="max_pax" id="max_pax" min="1" value="{{ old('max_pax') }}"
                                class="block w-full rounded-md border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 dark:bg-gray-900 dark:text-white dark:ring-gray-700"
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center gap-4">
                                <div x-show="!featuredImagePreview" class="w-32 h-24 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-600">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Recommended: 1200x800px, JPG or PNG</p>
                                </div>
                            </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <div x-show="galleryPreviews.length > 0" class="flex flex-wrap gap-3 mb-4">
                            ...
                            <input type="file" name="gallery[]" id="gallery" accept="image/*" multiple @change="previewGallery($event)"
                                class="block w-full text-sm text-gray-900 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100 dark:file:bg-primary-900/30 dark:file:text-primary-400">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Select multiple images. Recommended: 1200x800px, JPG or PNG</p>
                            @error('gallery')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 dark:border-gray-700 px-4 py-4 sm:px-8">
                ...
                <button type="submit"
                    class="rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">Create Package</button>
            </div>
        </form>
    </div>
